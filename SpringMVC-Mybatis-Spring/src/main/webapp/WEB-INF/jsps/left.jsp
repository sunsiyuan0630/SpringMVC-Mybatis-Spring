...
<body>
        ...
        <div class="c3" style="top: 0px; padding-top: 0px;height:100%;width:100%;">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="${pageContext.request.contextPath}/struts/outstorage?pageNum=1&pageSize=10" target="view_frame">出库/销售</a></li>
            <!-- <li><a href="${pageContext.request.contextPath}/struts/leftstorage?pageNum=1&pageSize=10" target="view_frame">查看库存</a></li> -->
            <li><a href="${pageContext.request.contextPath}/struts/outstorageRecord?pageNum=1&pageSize=10" target="view_frame">出库记录</a></li>
          </ul>
          <!-- 
          <ul class="nav nav-sidebar">
